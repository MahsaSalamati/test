...
public class FactorDto
{
    ...
    public long Type_tbl_F { get; set; }
    public string Type_Forosh { get; set; } = "";
    ...
    public decimal Tkh_K_F { get; set; }
    ...
    public string IS_PR { get; set; } = "چاپ شده";
